...
# -*- coding: utf-8 -*-
#
# Vakantiekieker documentation build configuration file, created by
...
htmlhelp_basename = 'Vakantiekiekerdoc'
...
man_pages = [
    (master_doc, 'vakantiekieker', 'Vakantiekieker Documentation',
     [author], 1)
]
